...
export const RCON_COMMANDS: RconCommandDef[] = [
  ...
  { cmd: 'GiveCreativeModeToPlayer', args: '<playerId>', help: 'Toggle creative mode for one player. Takes the numeric Player ID, not the EOS id.' },
  { cmd: 'GiveCreativeMode', help: 'Toggle creative mode for yourself (console only).' },
  { cmd: 'GiveCreativeModeToTarget', help: 'Toggle creative mode for whoever you are looking at (console only).' },
